...
<div class="container-fluid">
    ...
    <div class="row"  style="margin-bottom: 20px">
        <div class="col-sm-12">
            <form action="${pageContext.request.contextPath}/tag/insertTag" method="post" id="inputForm" class="form-inline">
                <div class="form-group">
                    <label for="name">标签名称:</label>
                    <input type="text" class="form-control" id="name" name="tname" placeholder="输入标签名称...">
                </div>
                <div class="form-group">
                    ...
                    <tr id="tr${tag.tid}">
                        ...
                        <td>
                            ...
                            <a href="javascript:" onclick="if(confirm('是否删除？'))
                                location.href='${pageContext.request.contextPath}/tag/delete?id=${tag.tid}';" methods="post" class="btn btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
