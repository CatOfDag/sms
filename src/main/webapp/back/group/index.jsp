...
<div class="container-fluid">
    ...
    <div class="row" style="margin-bottom: 10px">
        <div class="col-sm-12">
            <form id="inputForm" class="form-inline" action="${pageContext.request.contextPath}/group/insertGroup" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:" onclick="if(confirm('是否删除？'))
                                    location.href='${pageContext.request.contextPath}/group/delete?id=${group.id}';" methods="post" class="btn btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
...
<script>
    $(function(){
        //发送异步请求查询所有的班级信息
        $.get("${pageContext.request.contextPath}/class/findAllClass",function(res){
            //console.log(res);
