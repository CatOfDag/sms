...
<div class="container-fluid">
    ...
    <div class="row" style="margin:20px 0px;">
        <div class="col-sm-10 col-sm-offset-1 text-center">
            <form class="form-inline" action="${pageContext.request.contextPath}/student/selectByInput" method="post">
                            ...
                            <td>
                                <c:if test="${sessionScope.user.role=='admin'}">
                                    ...
                                    <a href="javascript:" onclick="if(confirm('是否删除？'))
                                            location.href='${pageContext.request.contextPath}/student/delete?id=${student.id}';" methods="post" class="btn btn-danger">删除</a>
                                </c:if>
                                <c:if test="${sessionScope.user.role!='admin'}">
                                    暂无权限!!!
                                </c:if>
