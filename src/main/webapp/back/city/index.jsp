...
<div class="container-fluid">
    ...
    <div class="row" style="margin-bottom: 20px">
        <div class="col-sm-12">
            <form class="form-inline" id="inputForm" action="${pageContext.request.contextPath}/city/insertCity" method="post">
                    ...
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="javascript:" onclick="if(confirm('是否删除？'))
                                    location.href='${pageContext.request.contextPath}/city/delete?id=${city.id}';" methods="post" class="btn btn-danger">删除</a>
                        </td>
                    </tr>
                </c:forEach>
            </table>
